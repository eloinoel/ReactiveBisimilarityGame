...
var Graph = /** @class */ (function () {
    ...
    Graph.prototype.print = function () {
        ...
        var i = 0;
        this.nodes.forEach(function (node) {
            var edgestring = "Vertex " + node.data + ": ";
...
var Node = /** @class */ (function () {
    ...
    Node.prototype.hasEdge = function (destination, edgeLabel) {
        return this.adjacent.some(function (edge) { return edge.node.data == destination && edge.edgeLabel == edgeLabel; });
    };
