...
export default class Level3_5 extends BaseScene {
    ...
    private setupLTS(): void {
        ...
        let game_controller = new PhaserGameController(this, Constants.lts_xy_offset, Constants.first_coordinates.clone().subtract(new Phaser.Math.Vector2(50, 50)), Constants.second_coordinates.clone().subtract(new Phaser.Math.Vector2(-50, 50)), level_description)
