...
export default class Level3_11 extends BaseScene {
    constructor() {
        super('ReBisim_Level11');
    }
    ...
    private setupLTS(): void {
        ...
        let level_description = new LevelDescription(this, this.renderer.width/2, 50, "3.11", "Reactive Bisimulation", true);
